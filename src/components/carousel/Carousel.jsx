    ...
    return (
        <div className="mb-13">
            <ContentWrapper className="relative">
                <BsFillArrowLeftCircleFill
                    className="text-3xl text-blackOne absolute top-[40%] translate-y-[-50%] cursor-pointer opacity-50 z-10 hidden md:block hover:opacity-80 left-8"
                    onClick={() => navigation("left")}
                />
                <BsFillArrowRightCircleFill
                    className="text-3xl text-blackOne absolute top-[40%] translate-y-[-50%] cursor-pointer opacity-50 z-10 hidden md:block hover:opacity-80 right-8"
